...
<title>Trabajo Final | Página Web</title>
		...
		<div id="content" class="site-content">
			<div id="primary" class="content-area column full">
				...
				?>
					...
					<h2 class="entry-title"><a href="portfolio-item.php?codigo= <?php echo $r["codigo"] ?>" rel="bookmark"><?php echo $r["nombre"] ?></a></h2>
					<a class='portfoliotype' href='portfolio-category.html'><?php echo $r["descripcion"] ?></a>
					<a class='portfoliotype' href='portfolio-category.html'><?php echo $r["precio"] ?></a>
